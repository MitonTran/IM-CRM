  ...
  return (
    <div className="overflow-x-auto">
      <table className="w-full min-w-[900px] border-separate border-spacing-0 text-left">
        <thead className="sticky top-0 z-10 bg-[#f8faf8]"><tr>{columns.map((column) => <th key={column.key} className={`border-b border-[#e2e9e4] px-4 py-3 text-[11px] font-bold uppercase tracking-[.1em] text-[#829088] ${column.className ?? ""}`}>{column.label}</th>)}</tr></thead>
