...
export function TargetForm({ teams, owners, period, start, end, defaultTeam }: {
  ...
  return <form action={action} className="mt-5 grid gap-3 sm:grid-cols-2">
    ...
    <label className="text-xs font-bold text-[#617168]">Giá trị mục tiêu<input name="targetValue" type="number" min="0" step="1" required placeholder="Ví dụ: 500000000" className="focus-ring mt-1 min-h-11 w-full rounded-xl border border-[#d8e2dc] bg-white px-3 text-sm" /></label>
