...
- Trợ lý AI hiển thị Groq, lịch sử hội thoại, model/token/latency và citation tới đúng PDF private; citation mở thành công qua Supabase signed URL. Hạn mức `20/20` được bỏ theo quyết định UAT ngày 2026-08-11; ledger/audit usage vẫn được giữ và Gemini là provider dự phòng khi Groq hết quota free hoặc tạm lỗi. Không có lỗi console trong lần kiểm tra trước thay đổi.
