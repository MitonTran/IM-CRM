...
M6.3 hiện có bản local gồm hội thoại owner-only, 7 tool đọc allowlist, full-text RAG có ACL/citation, quota dùng chung và audit metadata. Groq `openai/gpt-oss-20b` đã pass `3/3` hợp đồng live eval bằng dữ liệu giả ngày 2026-08-08; bằng chứng đã khử secret nằm tại `docs/17-ai-provider-eval-evidence.md`. Semantic/hybrid ranking và Preview smoke test có đăng nhập được giữ cho bước hardening trước khi đánh dấu M6 hoàn tất.
